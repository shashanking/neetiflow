...
| 2024-01-10 | Employee Timeline and Leads Page Updates | - Implemented comprehensive employee timeline tracking system<br>- Created `EmployeeTimelineEvent` entity and repository<br>- Added timeline visualization in employee details page<br>- Created `EmployeeTimelineBloc` for state management<br>- Fixed type conflicts in timeline implementation<br>- Removed analytics tab from leads page<br>- Streamlined leads page navigation with two tabs (Leads and Timeline)<br>- Added proper error handling and loading states for timeline<br>- Integrated with Firestore for real-time timeline updates |
| 2024-05-12 | Employee Management Enhancement | - Implemented comprehensive role-based access control system<br>- Added `Permission` enum for fine-grained access control<br>- Created role management system with `Role` entity<br>- Implemented `RolesBloc` for state management<br>- Added Firebase-based role repository<br>- Fixed role dropdown in employee form with proper state handling<br>- Added department management functionality<br>- Improved employee activation/deactivation UI<br>- Enhanced employee form with better validation<br>- Added role permissions widget for visual permission management<br>- Implemented secure role assignment workflow<br>- Added proper error handling and loading states<br>- Improved overall UI/UX for employee management |
